                ...
                <c:forEach var="item" items="${usuario}">
                    <tr>
                        ...
                        <td>${item.nombre}</td>    
                         <td>${item.apellido}</td>
                        <td>${item.email}</td>
                        <td><a href="UsuarioControlador?action=edit&id=${item.id}"><i class="fa-solid fa-pen-clip"></i></a></td>
                        <td><a href="UsuarioControlador?action=delete&id=${item.id}"
